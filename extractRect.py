...
def convert_object(image, screen_size = None, isDebug = False):
    ...
    plt.imshow( cv2.drawContours(imageCopy, countours, -1, (0, 255, 0), 1))
    plt.show()
    ...
    plt.imshow( cv2.drawContours(image.copy(), [screenCntList[0]], -1, (0, 255, 0), 3))
    plt.show()
...
img_path=r'D:\Projects\CVVeneer\data\train\15_3\IMG_2764.jpeg'

convert_object(cv2.imread(img_path), isDebug=1)
plt.show()